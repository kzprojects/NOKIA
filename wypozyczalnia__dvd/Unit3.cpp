...
//deklarujemy zmienn¹ int przypisujuj¹c jej wartoœæ pobranaz pliku INI
int num = Ini->ReadInteger("main", "numer", 0);

//podczas kazdego przebiegu pêtli FOR odejmujemy 1 dopkki'num' jest wieksze od 1
for(num; num>=1; num--)
{
//kasujemy z INI sekcjê o 'nazwie-liczbie' równej  wartosci zmiennej 'num'
